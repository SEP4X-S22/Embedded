...
void create_tasks_and_semaphores(void)
{
	...
	if ( sharedMutex == NULL )  // Check to confirm that the Semaphore has not already been created.
	{
		sharedMutex = xSemaphoreCreateMutex();  // Create a mutex semaphore.
		// xSemaphoreGive(sharedMutex); - redundant because a mutex is given when it is created
	}
